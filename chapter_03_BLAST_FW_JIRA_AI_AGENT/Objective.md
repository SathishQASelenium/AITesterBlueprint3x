...
You will be able to create a test plan based on the by fetching the KAN-3 automatically. @chapter_03_BLAST_FW/B.L.A.S.T.md  

GROQ - openai/gpt-oss-120b (FREE)
fETCH JIRA -> emAIL, token, JIRA - KAN-3 